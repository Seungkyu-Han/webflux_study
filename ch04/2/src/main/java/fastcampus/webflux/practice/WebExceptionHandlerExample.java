...
import fastcampus.webflux.exception.CustomException;
        ...
        var webHandler = new WebHandler(){
            ...
            public Mono<Void> handle(ServerWebExchange exchange) {
                ...
                return response.writeWith(
                        Mono.create(
                                sink -> sink.error(new CustomException("custom"))
                        )
                );
            }
        };
        ...
        var exceptionHandler = new WebExceptionHandler(){
            ...
            public Mono<Void> handle(ServerWebExchange exchange, Throwable ex) {
                ...
                if(ex instanceof CustomException) {
                    ...
                    var responseBody = response.bufferFactory().wrap(ex.getMessage().getBytes());
